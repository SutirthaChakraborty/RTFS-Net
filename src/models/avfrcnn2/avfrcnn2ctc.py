...
# LastEditTime: 2021-12-15 17:41:05
###
...
from .frcnnctc import FRCNNCTC as VideoFRCNN
...
class FRCNNBlock(nn.Module):
    def __init__(
        ...
        self.spp_dw = nn.ModuleList([CTCBlock(out_chan, norm_type, act_type, upsampling_depth, i) for i in range(upsampling_depth)])
...
class AVFRCNN2CTC(BaseAVEncoderMaskerDecoder):
    """
