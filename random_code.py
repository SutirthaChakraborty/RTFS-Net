...
from src.models.layers import MLPMixer, Permutator
...
if __name__ == "__main__":
    ...
    model = MLPMixer(
        image_size=((x.shape[3] // patch_size) * patch_size + patch_size, (x.shape[2] // patch_size) * patch_size + patch_size),
        channels=chan,
    ...
    print(x_pad.shape)
    print(model(x_pad).shape)

    m, p = get_MACS_params(model, (x_pad,))
