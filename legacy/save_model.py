...
from src.system.tensorboard import TensorBoardLogger
...
parser.add_argument("--gpus", type=int, default=8, help="#gpus of each node")
...
def main(conf):
    ...
    state_dict = torch.load(
        "/data/home/scv1134/run/chenhang/src-avdomain/egs/frcnn2_para/exp/vox2_10w_frcnn2_64_64_3_adamw_1e-1_blocks16_pretrain/checkpoints/epoch=129-val_loss=-12.12.ckpt"
    )
